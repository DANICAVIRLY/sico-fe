        ...
        <main className="p-4 sm:p-6 md:p-8 flex-1">
          {loading ? (
            ...
            <div className="w-full">
              <div className="mb-6">
                <h1 className="text-xl md:text-2xl font-bold text-gray-900">Data Mahasiswa</h1>
                  ...
                  currentData.map((item, index) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <span
                          className={`shrink-0 inline-block px-2.5 py-1 text-xs font-medium rounded-full whitespace-nowrap ${getStatusStyle(item.status)}`}
                        >
                          {item.status}
                        </span>
                      </div>
